package com.vic.villz.topartists.view
...
internal class GridPositionCalculator(var itemCount: Int) : GridLayoutManager.SpanSizeLookup(){
    ...
    companion object {
        ...
        private const val doubleSpanSize: Int = fullSpanSize / doubleSpanCount //3
        private const val tripleSpanSize: Int = fullSpanSize / tripleSpanCount //2
